...
public sealed class CreatePatientInsurancePolicyCommandValidator
    : AbstractValidator<CreatePatientInsurancePolicyCommand>
{
    public CreatePatientInsurancePolicyCommandValidator()
    {
        ...
        // Legacy Flex required the insured's identity whenever the subscriber wasn't the patient.
        // The Blazor rewrite dropped the rule; restored here (and in the domain) rather than ported.
