...
builder.Services.AddMediator(o =>
{
    ...
    [
        ...
        typeof(FSH.Modules.Patient.Contracts.PatientContractsMarker),
        typeof(FSH.Modules.Patient.PatientModule),
